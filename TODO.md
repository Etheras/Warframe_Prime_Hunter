...
### ~~When Baro leaves, his relic stops being mentioned at all~~

**Fixed 2026-09-08**, reasoning in `PROJECT.md §7` under *The planner counted a
wiki marker as a route, for the twelve days a fortnight it is not one*.
